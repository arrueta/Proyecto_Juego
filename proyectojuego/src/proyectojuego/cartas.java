...
public class cartas extends JComponent implements MouseListener {
    ...
    //iconos por defecto
    private Icon iconBack                   =       new ImageIcon(getClass().getResource("/imagenes2/moe.jpg"));
    private Icon iconFront                  =       new ImageIcon(getClass().getResource("/imagenes2/imcardistry.jpg"));
    ...
    public void setNameCharacter(String nameCharacter) {
        ...
        iconBack = new ImageIcon(getClass().getResource("/imagenes2/"+ this.nameCharacter +".jpg"));
//        iconBack = new ImageIcon(getClass().getResource("/imagenes3/"+ this.nameCharacter +".jpg"));
    }
